...
df = pd.read_csv("Desktop/Project_2/FRvideos.csv")
...
# Data to plot
labels = '2018', 'Episode', '2', '10', '2017', 'Johnny', 'Highlights'
sizes = [2982, 1906, 1224, 896, 803, 692, 683]
